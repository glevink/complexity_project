...
#write df to csv
jobtext_outf= open('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/word_clouds_jobtext_leader.csv', 'w+', encoding= 'utf-8')
...
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/distr_jobtext_words_leader.png')    
plt.show() 
...
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/distr_jobtext_tokens_leader.png')    
plt.show()  
...
wcloud.to_image()
wcloud.to_file('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/wcloud_top10predict_leader.png') 
...
#Visualize the word cloud
wcloud.to_image()
wcloud.to_file('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/wcloud_top10act_leader.png') 
...
#Visualize the word cloud
wcloud.to_image()
wcloud.to_file('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/wcloud_low10predict_leader.png') 
...
#Visualize the word cloud
wcloud.to_image()
wcloud.to_file('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/wcloud_low10act_leader.png') 
...
plt.xlabel('words')
plt.ylabel('counts')
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/top_v_low_pred_freq_leader.png')
plt.show()
...
plt.xlabel('words')
plt.ylabel('counts')
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/top_v_low_act_freq_leader.png')
plt.show()
...
plt.xlabel('words')
plt.ylabel('counts')
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/low_v_top_pred_freq_leader.png')
plt.show()
...
plt.xlabel('words')
plt.ylabel('counts')
plt.savefig('/Users/gschubert/Dropbox/PhD Course Notes/6.862 Machine Learning/complexity_project/Project proposal/low_v_top_act_freq_leader.png')
plt.show()
